...
<!-- 					<li><a href="student/dialog/1"><i class="fa fa-edit"></i>日语对话</a>
					</li> -->
					<li><a href="student/analysis"><i class="fa fa-dashboard"></i>信息统计</a>
					</li>
					<li><a href="student/change-password"><i class="fa fa-cogs"></i>个人设置</a>
					</li>
				</ul>
			</nav>
		</div>
	...
	<div class="full-slider" style="height: 128px;">
		<!-- Slider (Flex Slider) -->
					...
					<div class="flexslider">
						<div class="flex-caption">
							...
							<div class="col-l"  style="width:100%">
									<p style="text-indent:2em; font-size:20px;float: left;margin: 24px 0px 0px -35px;">一生懸命努力すればするほど、運は味方する！</p>
								</div>
							<!-- Right column -->
<!-- 							<div class="col-r" style="position: absolute;">
								Button
								<a class="btn btn-default btn-cta" href="user-register"><i
									class="fa fa-arrow-circle-down"></i> 立即注册</a>
								<a class="btn btn-default btn-cta" href="user-login-page"><i class="fa fa-arrow-circle-down"></i> 立即登录</a>
							</div>
 -->						</div>
					</div>
				</div>
	...
	<div class="content" style="margin-bottom: 100px;">
		...
		<div class="container">
			<div>
				...
				<div class="row">
					<div class="select-test col-xs-6" style="width: 38%">
					...
					<div class="select-test col-xs-6" style="width: 32%">
						<div style="height: 100px;">
							<div class="select-test-icon">
					...
					<div class="select-test col-xs-6" style="width: 29%">
						<div style="height: 100px;">
							<div class="select-test-icon">
								<i class="fa fa-superscript"></i>
							</div>
							<!-- <div class="select-test-content">
									<h3 class="title">日语对话</h3>
									<p>
										学习日语中常用的对话
									</p>
									<a class="btn btn-primary" href="student/dialog"><i class="fa fa-arrow-right"></i>参加练习</a>
								</div> -->
							<div class="select-test-content">
								<h3 class="title">日语对话</h3>
								<p>学习日语中常用的对话</p>
								<a class="btn btn-primary" data-toggle="modal"
									data-target=".dialogClassify"><i class="fa fa-arrow-right"></i>参加练习</a>
								<div class="modal fade dialogClassify" tabindex="-1"
									role="dialog" aria-labelledby="myLargeModalLabel"
									aria-hidden="true">
									<div class="modal-dialog">
										<div class="modal-content">
											<div class="modal-header">
												<button type="button" class="close" data-dismiss="modal"
													aria-hidden="true">&times;</button>
												<h6 class="modal-title" id="myModalLabel">会话分类</h6>
											</div>
											<div class="modal-body">
												<ul>
													<c:forEach items="${dialogClassifyInfo }" var="item">
														<li><span class="point-name"> ${item.key }</span> [共
															<span class="question-number-3"> <c:forEach
																	items="${item.value }" var="v">${v.value }</c:forEach>
														</span>题] <a
															href="student/dialog/<c:forEach items="${item.value }" var="k">${k.key }</c:forEach>"
															class="btn btn-success btn-sm join-practice-btn">前往</a></li>
													</c:forEach>
												</ul>
											</div>
											<div class="modal-footer">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<div class="copy">
							<p>
								Exam++ Copyright © <a href="http://www.examxx.net/" target="_blank">
								Exam++</a> - <a href="." target="_blank">主页</a>

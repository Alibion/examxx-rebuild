...
public class QuestionController {
     ...
     */
    @RequestMapping(
            value = "/admin/questionfilter-{fieldId}-{knowledge}-{questionType}-{searchParam}-{page}.html",
     ...
     */
    @RequestMapping(
            value = "/admin/questionfilterdialog-{fieldId}-{knowledge}-{questionType}-{searchParam}-{page}.html",
            method = RequestMethod.GET)
    ...
    @RequestMapping(
            value = "/admin/delete-question-list/{fieldId}-{knowledge}-{questionType}-{searchParam}-{page}/{questionId}",
            method = RequestMethod.GET)
    public String deleteQuestionList(Model model,
        ...
        return "admin/questionfilter-" + fieldId + "-" + knowledge + "-" + questionType + "-" + searchParam + "-" + page
                + ".html";
    }
    ...
    public @ResponseBody List<QuestionQueryResult> getQuestion5add(Model model, HttpServletRequest request,
    ...
    public @ResponseBody Message updateQuestion(@PathVariable int questionId, @PathVariable int pointId,
    ...
    public String knowledgePointPage(Model model, @PathVariable("fieldId") int fieldId,

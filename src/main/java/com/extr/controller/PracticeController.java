...
public class PracticeController {
     ...
     */
    @RequestMapping(
            value = "/student/practice-improve-his/{knowledgePointId}/{questionTypeId}",
        ...
        if (uqh != null) {
            if (uqh.getHistory().containsKey(0)) {
                ...
                while (wrongIt.hasNext()) {
                    ...
                    if (wrongMap.get(key).getPointId() == knowledgePointId
                            && wrongMap.get(key).getQuestionTypeId() == questionTypeId)
            ...
            if (uqh.getHistory().containsKey(1)) {
                ...
                while (rightIt.hasNext()) {
                    ...
                    if (rightMap.get(key).getPointId() == knowledgePointId
                            && rightMap.get(key).getQuestionTypeId() == questionTypeId)
            ...
            if (uqh.getHistory().containsKey(-1)) {
                ...
                while (otherIt.hasNext()) {
                    ...
                    if (otherMap.get(key).getPointId() == knowledgePointId
                            && otherMap.get(key).getQuestionTypeId() == questionTypeId)

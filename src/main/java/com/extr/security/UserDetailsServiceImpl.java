...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username)
         ...
         * userMapper.getUserGroupListByUserId(user.getId());
         * List<Job> jobList = userMapper.getJobListByUserId(user.getId(),
         * null);
         */
        ...
        userInfo = new UserInfo(username, user.getPassword(), user.getEnabled().equals("1"), true, true, true,
                authorities);

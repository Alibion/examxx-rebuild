...
public class JOD4DocToPDF {
    ...
    public boolean docToPdf(HttpServletRequest request) throws ConnectException {
         ...
         * "/WEB-INF/classes/OpenOffice_Service.bat");
         * path = path.replaceFirst(" ", "\" \"");
         * System.out.println(path);
         * try {
         * Process pro = Runtime.getRuntime().exec("d:\\1.bat");
         * StreamGobbler errorGobbler = new StreamGobbler(pro.getErrorStream(),
         * "Error");
         * StreamGobbler outputGobbler = new StreamGobbler(pro.getInputStream(),
         * "Iutput");
         *
         * errorGobbler.start();
         * outputGobbler.start();
